...
// Schema for POST /api/ro/applications/[id]/scrutiny
// Step 1: action="START" -> Initialize scrutiny (no OTP needed)
// Step 2: action="COMPLETE" -> Final decision with OTP
export const roScrutinySchema = z.discriminatedUnion("action", [
  ...
  // COMPLETE - Final decision (ACCEPTED or REJECTED)
  z.object({
